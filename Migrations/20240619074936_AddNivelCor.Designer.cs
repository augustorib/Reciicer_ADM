...
namespace Reciicer.Migrations
{
    ...
    [Migration("20240619074936_AddNivelCor")]
    partial class AddNivelCor
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Reciicer.Models.Entities.Premiacao", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            Ativo = true,
                            DataFinal = new DateOnly(2024, 6, 30),
                            DataInicial = new DateOnly(2024, 6, 1),
            ...
            modelBuilder.Entity("Reciicer.Models.Entities.Reciclagem", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            ClienteId = 1,
                            DataOperacao = new DateTime(2024, 6, 19, 4, 49, 35, 350, DateTimeKind.Local).AddTicks(1063),
                            PontuacaoGanha = 10
                        },
                        new
                        {
                            Id = 2,
                            ClienteId = 1,
                            DataOperacao = new DateTime(2024, 6, 19, 4, 49, 35, 350, DateTimeKind.Local).AddTicks(1076),
                            PontuacaoGanha = 5
                        });
                });
